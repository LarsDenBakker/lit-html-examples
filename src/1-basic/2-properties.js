...
class Properties extends LitElement {
  ...
  // Properties are be defined through a static getter. When defined, LitElement will reflect any
  // html attributes set on this component as properties which can be used from javascript.

  // Key should be the property name, value the property type.
  ...
  _render(props) {
    return html`
      <div>
        <!--
          Dynamic parts of your template are set through template string javascript expressions.
